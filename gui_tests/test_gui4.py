...
class Login(ct.CTkFrame):
    def __init__(self,root):
        ...
        re_me = ct.CTkCheckBox(main_frame, text='Remember me')
        re_me.grid(row=3, column=0, sticky="NSEW", pady=12, padx=40)
        ...
        for child in main_frame.winfo_children():
            Grid.rowconfigure(main_frame, child.grid_info()['row'], weight=1, minsize=130)
            Grid.columnconfigure(main_frame, child.grid_info()['column'], weight=1, minsize=600)
